...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiCallError<String>> handleNotFoundException(HttpServletRequest request, NotFoundException ex) {
        ...
        return ResponseEntity
                ...
                .body(new ApiCallError<>("Not found exception", new ArrayList<String>(){{ add(ex.getMessage());}}));
    }
    ...
    public ResponseEntity<ApiCallError<String>> handleValidationException(HttpServletRequest request, ValidationException ex) {
        ...
        return ResponseEntity
                .badRequest()
                .body(new ApiCallError<>("Validation exception", new ArrayList<String>(){{ add(ex.getMessage());}}));
    }
    ...
    public ResponseEntity<ApiCallError<String>> handleMissingServletRequestParameterException(HttpServletRequest request, MissingServletRequestParameterException ex) {
        ...
        return ResponseEntity
                .badRequest()
                .body(new ApiCallError<>("Missing request parameter", new ArrayList<String>(){{ add(ex.getMessage());}}));
    }

    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    public ResponseEntity<ApiCallError<String>> handleMethodArgumentTypeMismatchException(HttpServletRequest request, MethodArgumentTypeMismatchException ex) {
        logger.error("handleMethodArgumentTypeMismatchException {}\n", request.getRequestURI(), ex);

        List <String> details = new ArrayList<>();
        details.add("paramName" + ex.getName());
        details.add("paramValue" + ofNullable(ex.getValue()).map(Object::toString).orElse(""));
        details.add("errorMessage" + ex.getMessage());

        return ResponseEntity
                .badRequest()
                .body(new ApiCallError<>("Method argument type mismatch", details));
    }
    ...
    public ResponseEntity<ApiCallError<String>> handleAccessDeniedException(HttpServletRequest request, AccessDeniedException ex) {
        ...
        return ResponseEntity
                ...
                .body(new ApiCallError<>("Access denied!", new ArrayList<String>(){{add(ex.getMessage());}}));
    }
    ...
    public ResponseEntity<ApiCallError<String>> handleInternalServerError(HttpServletRequest request, Exception ex) {
        ...
        return ResponseEntity
                ...
                .body(new ApiCallError<>("Internal server error", new ArrayList<String>(){{add(ex.getMessage());}}));
    }
