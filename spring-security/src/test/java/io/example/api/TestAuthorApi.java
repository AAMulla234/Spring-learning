...
public class TestAuthorApi {
    ...
    public void testGetAuthorBooksSuccess() throws Exception {
        AuthorView authorView = authorTestDataFactory.createAuthor("Test Author A");
        BookView bookView1 = bookTestDataFactory.createBook(new ArrayList<String>(){{add(authorView.getId());}}, "Test Book A");
        BookView bookView2 = bookTestDataFactory.createBook(new ArrayList<String>(){{add(authorView.getId());}}, "Test Book B");
