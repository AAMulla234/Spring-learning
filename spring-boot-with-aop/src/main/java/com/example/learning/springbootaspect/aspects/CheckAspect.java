package com.example.learning.springbootaspect.aspects;
...
public class CheckAspect {
  ...
  @Before("@annotation(com.example.learning.springbootaspect.aspects.CheckSomething)")
  ...
  @AfterReturning(pointcut = "@annotation(com.example.learning.springbootaspect.aspects.CheckSomething)")
  ...
  @AfterThrowing(pointcut = "@annotation(com.example.learning.springbootaspect.aspects.CheckSomething)", throwing = "ex")
  ...
  @Around("@annotation(com.example.learning.springbootaspect.aspects.CheckSomething)")
